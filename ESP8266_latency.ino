...
void serverDemo()
{
  ...
  if (client) 
  {
    Serial.println(F("latency client connected!"));
    ...
    while (client.connected()) 
    {
      if (client.available()) 
      {
        ...
        String mystring = (char)ca+(char)cb+(char)cc+(char)cd+(char)ce+(char)cf+(char)cg+(char)ch;

        Serial.print(F(mystring));*/
